...
## Project Structure
    ...
    ├── testapiautosetting_121079  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_121079`
...
2. Clone this repo and `cd testapiautosetting_121079`
